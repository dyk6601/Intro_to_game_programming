...
enum EntityType   { PLAYER, BLOCK, PLATFORM, WINNING_PLATFORM, NONE };
...
private:
    ...
    bool mTouchedBlock = false;
    bool mTouchedWinningPlatform = false;

    EntityStatus mEntityStatus = ACTIVE;
    EntityType   mEntityType;
    ColliderType mColliderType = BOX;
    float mColliderRadius = 125.0f;

    Vector2 getColliderCenter() const;
    Vector2 getColliderHalfExtents() const;
...
public:
    ...
    bool isActive() const { return mEntityStatus == ACTIVE ? true : false; }
    ...
    float       getColliderRadius()        const { return mColliderRadius;          }
    ...
    bool hasTouchedBlock() const { return mTouchedBlock; }
    bool hasTouchedWinningPlatform() const { return mTouchedWinningPlatform; }
