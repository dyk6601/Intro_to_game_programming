...
private:
    ...
    int mSpeed;
    float mAngle;
    Shader mRenderShader = { 0, nullptr };
    bool mUseRenderShader = false;
...
public:
    ...
    void render();
    bool hasCollidedWith(Entity *other) const;
    ...
    void setAnimationAtlas(std::map<Direction, std::vector<int>> newAnimationAtlas)
    {
        mAnimationAtlas = newAnimationAtlas;
    ...
    void setAnimateWhenStill(bool shouldAnimate)
        { mAnimateWhenStill = shouldAnimate;       }
    ...
    void setRenderShader(Shader shader)
        { mRenderShader = shader; mUseRenderShader = true; }
    void clearRenderShader()
        { mUseRenderShader = false; }
};
