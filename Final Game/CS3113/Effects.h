...
enum class EffectType { NONE, FADEIN, FADEOUT, SHRINK, GROW, TORCH_FLICKER };
...
public:
    static constexpr float SOLID       = 1.0f,
                           ...
                           TORCH_BASE_ALPHA = 0.30f,
                           TORCH_PULSE_SPEED = 14.0f,
                           TORCH_PULSE_INCREMENT = 196.0f,
                           TORCH_PULSE_STRENGTH = 0.06f;
